              ...
              <Row label="Bookings — sticky header, row actions, bulk actions, export">
                <div className="w-full">
                  <DataTableFixed
                    ...
                    defaultPageSize={8}
                    onRowClick={(row) => toast(`Clicked: ${row.ref}`)}
                    rowActions={[
                      { label: "View booking",      onClick: (r) => toast.info(`Viewing ${r.ref}`)              },
                      { label: "Edit booking",      onClick: (r) => toast(`Editing ${r.ref}`)                   },
                      { label: "Cancel booking",    onClick: (r) => toast.error(`${r.ref} cancelled`), variant: "destructive" },
                    ]}
                    bulkActions={[
