  ...
  return (
    <section className="flex flex-col gap-10 py-16">
      <div className="flex flex-col items-center gap-6">
        ...
        >
          <ToggleGroupItem value="monthly" className="h-8 w-32 rounded-md data-[state=on]:bg-primary data-[state=on]:text-primary-foreground data-[state=on]:shadow-sm text-muted-foreground">Monthly</ToggleGroupItem>
          <ToggleGroupItem value="yearly"  className="h-8 w-32 rounded-md data-[state=on]:bg-primary data-[state=on]:text-primary-foreground data-[state=on]:shadow-sm text-muted-foreground">Yearly</ToggleGroupItem>
        </ToggleGroup>
      </div>
