...
type PreviewBarProps = {
  activePage: "components" | "forms" | "tables" | "charts" | "navigation" | "demos" | "typography"
}
...
export function PreviewBar({ activePage }: PreviewBarProps) {
  ...
  const activeLabel = kitPages.find(p => p.href === `/${activePage}`)?.label
